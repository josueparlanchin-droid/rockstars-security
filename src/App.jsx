      ...
      <main className="main-content">
        ...
        <div className="slide-controls">
          ...
          <div className="progress-indicator">
            Diapositiva {currentSlide} de {totalSlides}
        ...
        <section className={`report-card slide-format ${currentSlide === 1 ? 'active' : 'hidden'}`}>
          <span className="rubric-tag rubric-tag-red">Criterio 2.1.1</span>
          <h2>1. Marco Normativo Nacional e Internacional</h2>
          <div className="card-body">
            <p className="slide-subtitle">Evaluación de normativas aplicables al compromiso de activos de información en el desarrollo de GTA VI:</p>
            <div className="norm-grid">
              <div className="norm-item inacap-border animate-pop">
        ...
        <section className={`report-card slide-format ${currentSlide === 2 ? 'active' : 'hidden'}`}>
          <span className="rubric-tag rubric-tag-red">Criterio 2.1.2</span>
          <h2>2. Tipificación de Delitos Informáticos (Ley 21.459)</h2>
          <div className="card-body">
            <p className="slide-subtitle">Mapeo de las conductas ejecutadas por el atacante (Lapsus$) bajo la legislación penal informática chilena:</p>
            <table className="legal-table inacap-table animate-fade-up">
              <thead>
                <tr>
        ...
        <section className={`report-card slide-format ${currentSlide === 3 ? 'active' : 'hidden'}`}>
        ...
        <section className={`report-card slide-format ${currentSlide === 4 ? 'active' : 'hidden'}`}>
        ...
        <section className={`report-card slide-format ${currentSlide === 5 ? 'active' : 'hidden'}`}>
          ...
          <div className="card-body arco-layout">
            
            <div className="data-classification inacap-box animate-pop data-box-1">
              <h3>Clasificación de Datos Comprometidos</h3>
              <ul className="animated-list">
                <li className="list-item"><strong>Datos Personales:</strong> Nombres de usuario, correos electrónicos corporativos e identificadores de Slack.</li>
                <li className="list-item"><strong>Datos Sensibles:</strong> Comunicaciones internas que vulneraron la esfera íntima del desarrollo estratégico y opiniones de los empleados.</li>
              </ul>
            </div>
            
            <div className="arco-analysis inacap-box animate-pop data-box-2">
              <h3>Análisis de Derechos ARCO Afectados</h3>
              <ul className="animated-list arco-stagger">
                <li className="list-item arco-item">
                  <span className="icon">🔓</span> 
                  <div><strong>Derecho de Acceso:</strong> El atacante impidió que los titulares validaran el resguardo de su información laboral en los servidores.</div>
                </li>
                <li className="list-item arco-item">
                  <span className="icon">❌</span> 
                  <div><strong>Derecho de Cancelación:</strong> Los ingenieros perdieron el control para exigir la eliminación de sus datos tras la filtración pública.</div>
                </li>
                <li className="list-item arco-item">
                  <span className="icon">✋</span> 
                  <div><strong>Derecho de Oposición:</strong> Absoluta imposibilidad de oponerse al tratamiento y distribución global de su información de contacto.</div>
                </li>
              </ul>
            </div>
